...
<body>
    <div id="contrat-cspe">
        <div class="page-1">
            ...
            <p>Grâce à cet abonnement, vous bénéficiez d’un service de mise en relation avec des professionnels
                qualifiés de
                votre secteur pour vos travaux d’électricité,et de chauffage ainsi que d’un service d’aide à
                l’optimisation
            ...
            <p>Votre service <strong>CSPE</strong> vous coûtera seulement 15,90€ TTC/trimestre soit 63,60 € TTC/an, avec
                un
                engagement de 12
                mois. A l'issue du délai de renonciation, nous vous prélèverons votre cotisation mensuelle de 15,90 €
                TTC
            ...
            <p>Nous vous invitons à lire avec attention ces documents qui précisent l’ensemble de vos droits et
                obligations.
            </p>
        ...
        <div class="page-2">
            ...
            <div style="border: 2px solid;padding:5px;margin-bottom:15px;">
                ...
                <p>Code postal : {{ $contrat['zipcode'] }} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Ville :
                    {{ $contrat['ville'] }}
                </p>
            ...
            <div style="margin: 10px 0">
                <strong>
                    Je demande ma souscription au contrat CSPE de la société CSPE, je déclare avoir pris connaissance
                    des
            ...
            <div>
                <p>Je reconnais être informé que les informations recueillies sont nécessaires à l'appréciation et au
                    traitement de mon dossier d'adhésion et que les informations administratives font l'objet de
                    traitements
                ...
                <p>Je déclare en outre avoir pris connaissance que mes communications téléphoniques avec les services de
                    CSPE peuvent faire l'objet d'un enregistrement, pour les besoins de gestion interne et que je peux
                    avoir
                    accès aux enregistrements me concernant en m’adressant par écrit à CSPE, 78 avenue des champs
                    Elysees –
                    75008 - Paris. Je certifie avoir répondu avec exactitude et sincérité à l'ensemble des questions
                    posées,
        ...
        <div>
            ...
            <div>
                Vous venez de souscrire auprès de CSPE un abonnement de service et nous vous remercions de votre
                confiance.
                Sur
                simple appel, ce contrat vous permet d’être mis en relation, pour vos petits travaux, avec un
                professionnel
                ...
                ainsi
                que des conditions particulières définies lors de votre souscription en fonction des éléments que vous
                nous
                avez
                communiqués.
            </div>
            ...
            <p>
                <span style="color: rgb(44, 151, 223)">« Le Client » / « Vous » :</span> Toute personne physique qui
                agit à
                des fins qui n'entrent pas dans le cadre de
                son
                activité commerciale, industrielle, artisanale, libérale ou agricole, à l’exclusion des professionnels
                et
            ...
            <p>
                ...
                1.000 euros, 78 AV DES CHAMPS ELYSEES, 75008 PARIS - RCS Paris B 952 704 666 , et chargé de la
                prestation de
                service associée au contrat CSPE.
            </p>
            <p>
                <span style="color: rgb(44, 151, 223)">« Devis » :</span> Document remis au Client à titre gratuit par
                email
            ...
            <div>
                <p>
                    ...
                    accessible du
                    lundi au samedi de 10h à 20h. CSPE vous accompagne dans la mise en relation et la constitution de
                    vos
                    dossiers
            ...
            <p>
                <span style="color: rgb(44, 151, 223)">- Chauffage :</span> installation, réparation de votre chaudière
                gaz,
            ...
            <p>
                ...
                l’Intervention,
                le calendrier souhaité pour l’Intervention ainsi que les coordonnées de contact permettant la
                réalisation de
                l’Intervention. Si lors du diagnostic préliminaire, il apparaît qu’une intervention s’avère nécessaire,
                le
                Service Client vous propose un Prestataire qualifié pour l’Intervention et effectue, avec votre accord,
                la
                mise
                en relation. Vous restez libre de
                refuser le Prestataire proposé par le Service Clientèle ; dans ce cas, il reconnaît toutefois la
                réalisation
                de
                la mission de mise en relation effectuée par CSPE au titre du service.
            </p>
            <p>
                Le Service Clientèle organise l’Intervention auprès du Prestataire dans un délai de trois (24) heures
                pour
                le
            ...
            <p>
                La validation de la commande et le recouvrement des factures issues de l’Intervention reste à la charge
                du
                Client dans le cadre du contrat
                entre le Client et le Prestataire ; CSPE n’intervenant pas dans la relation contractuelle établie entre
                le
                Client et le Prestataire.
            </p>
            <p>
                Il est de la responsabilité du Client de garantir la conformité de son installation électrique, de gaz
                ou de
                sa
                chaudière/chauffage aux normes réglementaires en vigueur. Si l’installation faisant l’objet du dépannage
                ne
                remplit pas ces conditions, le Prestataire peut refuser d’intervenir. Le Client reconnaît qu’en aucun
                cas,
                CSPE
                ne participe à la relation contractuelle existant entre lui et le Prestataire ni ne pourra être tenu
                responsable
                de la prestation réalisée par le Prestataire. Le Client peut utiliser le service de mise en relation
                proposé
                par
            ...
            <p>
                Le service client CSPE vous accompagne et vous aide à détecter les aides financières disponibles telles
                que:
            </p>
            <div>
                <p>
            ...
            <p>
                Le service client CSPE pourra également vous accompagner dans l’optimisation de vos factures
                d’électricité
                et de
                gaz en comparant les offres disponibles sur le marché.
            </p>
            <p>
                Les réponses délivrées sont en fonction des faits et situations exposées et revêtent un caractère
                informatif
                qui
            ...
            <p>
                Si vous avez une réclamation à formuler quant à la souscription du contrat de prestation de service ou à
                la
                délivrance de la prestation de service de mise en relation avec un professionnel, vous pouvez la
                formuler
                auprès
            ...
            <p>
                Les services concernés accuseront réception de votre réclamation sous 10 jours ouvrables et étudieront
                votre
                réclamation afin de résoudre votre insatisfaction. Le maximum sera fait pour vous apporter une réponse
                dans
                un
                délai de 10 jours ouvrables à compter de l’envoi de votre réclamation écrite ; si ce délai devait être
                prolongé,
                vous serez tenu informé du déroulement du traitement de sa réclamation dans ce même délai, sans que le
                délai
                de
                traitement de la réclamation ne puisse dépasser deux mois à compter de l’envoi de votre réclamation
                écrite.
            </p>
            <p style="background-color:rgb(44, 151, 223);color:white;font-weight:bold;">
                3. MÉDIATION
            ...
            <p>
                ...
                vous
                pouvez faire appel à : Médiation de la Consommation et du Patrimoine – 12 square Desnouettes – 75015
                Paris –
                mcpmediation.org
                Le Médiateur est une autorité indépendante et extérieure à notre société, qui examine et donne un avis
                sur
                le
            ...
            <p>
                En application de l’article 2238 du Code civil, le recours à la médiation suspend le délai de
                prescription
                des
                actions.
            </p>
            <p>
                La suspension a pour effet d’arrêter temporairement le cours de la prescription, mais n’efface pas le
                délai
            ...
            <p>
                ...
                (changement
                d'adresse, de coordonnées bancaires...), un conseiller se tient à votre disposition du lundi au samedi
                de
                10h00
            ...
            <p>
                Le contrat prend effet à compter de la date indiquée sur vos Conditions Particulières ou sur votre
                Bulletin
                de
            ...
            <p>
                ...
                échéance, sauf si l’une des parties au contrat résilie le contrat suivant les conditions définies
                ci-après à
                la
            ...
            <p>
                Le montant de votre abonnement est calculé forfaitairement. Des frais de gestion peuvent vous être
                demandés.
                Le montant de votre abonnement est assujetti à la Taxe sur la Valeur Ajouté en vigueur au jour du
                règlement
                de
            ...
            <p>
                En cas de non-paiement des cotisations, nous pouvons résilier votre contrat suivant les conditions
                prévues à
            ...
            <p>
                Le tarif est modifié chaque année selon la variation annuelle de l’indice des prix à la consommation,
                hors
                tabac
                de l’ensemble des ménages établi par l’INSEE et publié au journal officiel du mois de janvier de l’année
                à
            ...
            <p>
                Nous sommes titulaires du même droit, en vous notifiant notre décision de résilier votre contrat par
                lettre
                recommandée avec accusé de réception adressée à votre dernier domicile connu, dans les mêmes délais.
                Conformément aux dispositions des articles L215-1 à L215-3 et à l’article L241-3 du code de la
                consommation,
                en
                l’absence de courrier ou mail adressé par nos services vous informant de la possibilité de ne pas
                renouveler
                votre contrat au plus tard un mois avant la date anniversaire de votre contrat, vous pourrez mettre un
                terme
                au
            ...
            <p>
                ...
                reconduction
                tacite, le professionnel prestataire de services informe le consommateur par écrit, par lettre
                nominative ou
                courrier électronique dédiés, au plus tôt trois mois et au plus tard un mois avant le terme de la
                période
            ...
            <p>
                ...
                indéterminée,
                après la date de transformation du contrat initial à durée déterminée, sont dans ce cas remboursées dans
                un
                délai de trente jours à compter de la date de résiliation, déduction faite des sommes correspondant,
                jusqu’à
            ...
            <p>
                « Les dispositions du présent chapitre ne sont pas applicables aux exploitants des services d’eau
                potable et
                d’assainissement. »
            </p>
            <p>
            ...
            <p>
                « Les dispositions des articles L215-1 à L215-3 et L241-3 sont intégralement reproduites dans les
                contrats
                de
            ...
            <p>
                En cas de révision du montant de votre abonnement autre que celle prévue au contrat ou imposée par la
                loi en
                vigueur. Dans ce cas, vous disposez d’un mois pour notifier la résiliation de votre contrat par lettre
                recommandée avec accusé de réception, laquelle prendra effet un mois après réception de ladite lettre.
                Vous
                devrez alors nous régler la mensualité sur la base du tarif avant révision, au prorata du temps écoulé
                entre
                la
            ...
            <p>
                En cas de non-paiement de vos mensualités, nous vous adressons une lettre de mise en demeure à votre
                dernier
                domicile connu. Si nous sommes sans réponse de votre part à cette lettre à l’expiration d’un délai de
                trente
        ...
        <div>
            ...
            <p>
                Les données personnelles recueillies font l’objet de traitements destinés à la souscription/l’adhésion,
                la
            ...
            <p>
                ...
                partenaires nous engageons à prendre les mesures techniques et organisationnelles appropriées pour
                garantir
                un
                niveau de sécurité et de confidentialité adapté au risque présenté par le traitement de vos données et à
                notifier à la CNIL et vous informer en cas de violation de vos données dans les limites et conditions
                des
                articles 33 et 34 du RGPD.
            </p>
            <p>
                Si vous avez donné votre consentement, nous pouvons transmettre vos données à nos partenaires pour
                recevoir
            ...
            <p>
                La liste de nos partenaires peut vous être transmise sur demande auprès de notre Délégué à la Protection
                des
                Données.
            </p>
            <p>
            ...
            <p>
                Ces transferts sont encadrés par des règles de protection et de sécurité des données qui peuvent vous
                être
                transmises sur demande par notre Délégué à la Protection des Données.
            </p>
            <p>
                Afin de mesurer et améliorer notre qualité de service, vos échanges de courriers, télécopies, courriels
                et
                conversations téléphoniques avec notre société sont susceptibles d’être analysés et enregistrés et de
                faire
                ...
                informatique et Libertés n° 78-17 du 6 janvier 1978 modifiée par la loi n° 2004-801 du 6 août 2004, la
                loi
                n°
                2018-493
            </p>
            <p>
                ...
                (Règlement
                Général sur la Protection des Données) du 27 avril 2016 relatif à la protection des personnes physiques
                à
                l’égard des traitements de données à caractère personnel et à la libre circulation de ces données
                (RGPD),
                vous
                bénéficiez d’un droit d’accès, de rectification, d’effacement (des données inexactes, incomplètes,
                équivoques,
                périmées ou dont le traitement serait illicite), de limitation des traitements (dans les cas prévus par
                la
                loi),
                d’opposition pour motif légitime, de suppression de vos données à caractère personnel.
            </p>
            <p>
                Vous possédez un droit à la portabilité de vos données (dans les cas prévus par la loi) ainsi que du
                droit
                de
                définir des directives relatives à la conservation, l’effacement et à la communication de ces données
                après
                votre décès. Vous pouvez enfin vous opposer, à tout moment et sans frais à la prospection commerciale.
                Ces
            ...
            <p>
                Vous bénéficiez du droit d’introduire une réclamation auprès de la CNIL sur son site : www.cnil.fr ou
                par
                courrier à l’adresse Commission Nationale Informatique et Libertés - TSA 80715 - 3 Place de Fontenoy-
                75334
            ...
            <p>
                ...
                démarchage
                par téléphone, par le biais d’un moyen de communication à distance ou encore hors établissement
                (démarchage
                à
                domicile, sur lieu de travail) dans les conditions de l’article L221-18 du code de la consommation.
            </p>
            <p>
                Vous disposez alors d’un délai de quatorze (14) jours à compter du lendemain de la signature du contrat
                pour
            ...
            <p>
                Cette renonciation n’est valable que si elle est adressée dans le délai mentionné ci-dessus,
                lisiblement,
            ...
            <p>
                ...
                rembourser
                dans les 30 jours suivants. Pour exercer votre droit de renonciation, vous pouvez utiliser le modèle en
                bas
                de
        ...
        <div>
            ...
            <div style="border: 2px solid;border-top:none;margin-bottom:10px;padding:5px">
                ...
                <p>Je/nous (*) vous notifie/notifions (*) par la présente ma/notre (*) rétractation du contrat portant
                    sur
        ...
        <div>
            <div style="border: 2px solid;padding:5px">
                ...
                <p>Vous autorisez CSPE à envoyer des instructions à votre banque pour débiter votre compte, et votre
                    banque
                    à débiter votre compte
                    conformément aux instructions de CSPE. Vous bénéficiez du droit d'être remboursé par votre banque
                    selon
                    les conditions décrites
                    dans la convention que vous avez passée avec elle. Une demande de remboursement doit être présentée
                    dans
