...
<body>
    ...
    <div class="page-1">
        ...
        <p>Lors de la conversation téléphonique du {{ date('d/m/Y') }} que vous avez eue avec notre partenaire, vous
            avez
            souhaité souscrire au contrat <strong>CSPE PLUS</strong>, et nous tenons à vous souhaiter la bienvenue.</p>
    ...
    <div class="page-2">
        ...
        <div style="margin: 10px 0">
            <strong>
                Je demande ma souscription au contrat CSPE PLUS de la société CSPE PLUS, je déclare avoir pris connaissance des
        ...
        <div>
            <p>Je reconnais être informé que les informations recueillies sont nécessaires à l'appréciation et au
                ...
                offres et produits proposés par CSPE PLUS par courrier en écrivant à CSPE PLUS – 78 avenue des champs Elysees –
                75008 - Paris.</p>
            <p>Je déclare en outre avoir pris connaissance que mes communications téléphoniques avec les services de
                CSPE PLUS peuvent faire l'objet d'un enregistrement, pour les besoins de gestion interne et que je peux avoir
    ...
    <div>
        ...
        <div>
            <p>
                ...
                accessible du
                lundi au samedi de 10h à 20h. CSPE PLUS vous accompagne dans la mise en relation et la constitution de vos
                dossiers
        ...
        <p>
            ...
            auprès
            de votre interlocuteur habituel : CSPE PLUS au 09 85 40 68 73 ou par email à l’adresse contact@CSPE PLUS.me.
        </p>
        <p>
        ...
        <p>
            ...
            lettre
            recommandée avec accusé de réception à l’adresse suivante : Société CSPE PLUS – 78 Avenue des champs Elysees –
            75008
    ...
    <div>
        ...
        <div style="border: 2px solid;border-top:none;margin-bottom:10px;padding:5px">
            <p style="margin-top: 0">Je soussigné(e), déclare renoncer à l'offre CSPE PLUS n°{{ $contrat['rum'] }}.</p>
            ...
            <p>CSPE PLUS Service Qualité – 78 AVENUE DES CHAMPS ELYSEES - 75008 – PARIS</p>
            <p>Je/nous (*) vous notifie/notifions (*) par la présente ma/notre (*) rétractation du contrat portant sur
                ...
                services CSPE PLUS, numéro {{ $contrat['rum'] }}
            </p>
    ...
    <div>
        <div style="border: 2px solid;padding:5px">
            ...
            <p>Vous autorisez CSPE PLUS à envoyer des instructions à votre banque pour débiter votre compte, et votre banque
                ...
                conformément aux instructions de CSPE PLUS. Vous bénéficiez du droit d'être remboursé par votre banque selon
